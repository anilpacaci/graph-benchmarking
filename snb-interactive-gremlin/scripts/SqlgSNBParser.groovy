...
class SqlgSNBParser {
    ...
    static class GraphLoader implements Callable {
        ...
        GraphLoader(SqlgGraph graph, SharedGraphReader graphReader, ElementType elementType) {
            this.graph = graph
                    ...
                    for (int i = 0; i < lines.size(); i++) {
                        try {
                            ...
                            if (elementType == ElementType.VERTEX) {
                                ...
                                if (isIdMappingEnabled) {
                                    String id1 = idMappingServer.getId(entityName + ":" + colVals[0])
                                    String id2 = idMappingServer.getId(v2EntityName + ":" + colVals[1])
    ...
    static void loadSNBGraph(SqlgGraph graph, String configurationFile) throws IOException {
